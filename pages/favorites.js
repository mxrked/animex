...
// Style Imports
import "../assets/styles/modules/Favorites/Favorites.module.css";

export default function Favorites() {
  const router = useRouter();

  // Disable Favorites Links
  useEffect(() => {
    ManipPageLinks("disable", ".favorites-link");
  }, []);

  return (
    <div id="PAGE" className="page half-second overrides_Favorites">
      <HeadCnt
        title="ANIMEX - My Favorites."
        ...
        robots="index, follow"
        url="https://effervescent-churros-110c8b.netlify.app/favorites/"
      />
