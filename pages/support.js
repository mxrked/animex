...
// Style Imports
import "../assets/styles/modules/Support/Support.module.css";
...
export default function Support() {
  ...
  // Disable Info Links
  useEffect(() => {
    ManipPageLinks("disable", ".support-link");
  }, []);

  return (
    <div id="PAGE" className="page half-second overrides_Support">
      <HeadCnt
        title="ANIMEX - Support/Contact"
        ...
        robots="index, follow"
        url="https://effervescent-churros-110c8b.netlify.app/support/"
      />
